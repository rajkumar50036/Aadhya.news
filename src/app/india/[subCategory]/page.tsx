...
export default async function IndiaSubCategoryPage({
  params,
}: {
      ...
      {stories.length === 0 ? (
        <div className="p-12 text-center bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-2">
          <p className="text-slate-700 dark:text-slate-300 font-semibold">
            No stories currently found for India <span className="capitalize">{titleFormatted}</span>.
          </p>
